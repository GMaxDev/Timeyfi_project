...
export default function Profile({className=""}) {
  return (
    ...
    >
      ...
      <PopoverPanel
        transition
        className="absolute -right-8 top-14 min-w-full w-96 bg-white shadow-md rounded-lg p-2 transition duration-200 ease-in-out data-[closed]:-translate-y-1 data-[closed]:opacity-0"
      >
        <div
        ...
        <div
          ...
          href="/goals"
        >
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Perferendis, dignissimos?
        </div>
      </PopoverPanel>
    </Popover>
  );
